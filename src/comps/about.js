  ...
  <motion.path
     ...
     variants={jsIcon}
      ...
      />
                        ...
                        <h2 className="headline">Web App<br></br>Dev</h2></div>
    ...
    animate="visible"
        ...
        pathLength: { delay:3, duration: 2, ease: "easeIn"}}} />
                    ...
                    <motion.li className="about-card" 
                        ...
                        <div className="headline-wrapper">
                            <motion.svg className="node" fill="#ffffff" width="800px" height="800px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
