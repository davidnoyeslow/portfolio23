            ...
            <div className="overlay2" style={{backgroundSize:"6px", opacity: 0.9}}></div>
                <motion.ul className="card-wrapper" initial='offscreen' variants={variants} animate='onscreen'>
                    <motion.li className="about-card" 
                        ...
                        onClick={(e) => setState({...state, openWebCard: state.openWebCard ? false : true, openUXCard: false, openBackCard: false})}>
    ...
    <motion.path
        ...
        />
                    ...
                    <motion.li className="about-card"  
                        ...
                        onClick={(e) => setState({...state, openWebCard: false, openUXCard: state.openUXCard ? false : true, openBackCard: false})}>
                        <div className="headline-wrapper">
                        <motion.svg
    ...
    animate="visible"
        ...
        pathLength: { delay:3, duration: 2, ease: "easeIn"}}} />
                    ...
                    <motion.li className="about-card" 
                        ...
                        onClick={(e) => setState({...state, openWebCard: false, openUXCard: false, openBackCard: state.openBackCard ? false : true})}>
                        <div className="headline-wrapper">
